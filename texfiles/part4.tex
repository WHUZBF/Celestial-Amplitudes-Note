...
经典引力理论的散射问题就是在找$\mathcal{I}^+$上的Cauchy data到$\mathcal{I}^-$上的Cauchy data的映射。不过上面的initial data还无法完全使得此问题well-define，文献\cite{Strominger:2013jfa}从Lorentz和CPT不变性的要求出发，认为需要加入下面的对径认同假设来构成散射问题的全部：
\begin{equation}
